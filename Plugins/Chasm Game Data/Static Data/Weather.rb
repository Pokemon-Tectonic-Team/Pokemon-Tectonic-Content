...
GameData::Weather.register({
	...
	:category         => :Rain,
	:particle_names   => %w[storm_1 storm_2 storm_3 storm_4], # Last is splash
...
GameData::Weather.register({
	...
	:category         => :Hail,
	:particle_names   => %w[blizzard_1 blizzard_2 blizzard_3 blizzard_4],
...
GameData::Weather.register({
	...
	:id_number        => 5,
	:category         => :Sandstorm,
	:particle_names   => %w[sandstorm_1 sandstorm_2 sandstorm_3 sandstorm_4],
...
GameData::Weather.register({
	...
	:category         => :Hail,
	:particle_names   => %w[crystal_snow_1 crystal_snow_2 crystal_snow_3 crystal_snow_4],
	:particle_delta_x => proc do
