...
NON_RAF_LEGEND = %i[ZERAORA MELOETTA SHAYMIN ZAMAZENTA RAIKOU ENTEI SUICUNE COBALION TERRAKION VIRIZION ZAMAZENTA XERNEAS DEOXYS ZYGARDE KYOGRE DARKRAI GENESECT GLASTRIER NECROZMA]

RAF_LEGEND_MON = %i[DIANCIE CALYREX SPECTRIER ZACIAN RAYQUAZA YVELTAL GROUDON]
