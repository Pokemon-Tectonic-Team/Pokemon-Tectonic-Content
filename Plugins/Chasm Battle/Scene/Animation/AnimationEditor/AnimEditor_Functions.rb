...
def pbTweening(canvas)
  sliderwin2=ControlWindow.new(0,0,320,32*12)
  sliderwin2.viewport=canvas.viewport
  sliderwin2.opacity=200
  ...
  set3=sliderwin2.addCheckbox(_INTL("Blending Color"))
  set4=sliderwin2.addCheckbox(_INTL("Color Tone"))
  okbutton=sliderwin2.addButton(_INTL("OK"))
  cancelbutton=sliderwin2.addButton(_INTL("Cancel"))
  loop do
    Graphics.update
    ...
    if sliderwin2.changed?(okbutton) || Input.trigger?(Input::USE)
      ...
      for j in startcel..endcel
        ...
        diffPattern         = cel2[AnimFrame::PATTERN] - startPattern
        diffX               = cel2[AnimFrame::X] - startX
        diffY               = cel2[AnimFrame::Y] - startY
        diffZoomX           = cel2[AnimFrame::ZOOMX] - startZoomX
        diffZoomY           = cel2[AnimFrame::ZOOMY] - startZoomY
        diffAngle           = cel2[AnimFrame::ANGLE] - startAngle
        diffOpacity         = cel2[AnimFrame::OPACITY] - startOpacity
        diffBlend           = cel2[AnimFrame::BLENDTYPE] - startBlend
        diffColorRed        = cel2[AnimFrame::COLORRED] - startColorRed
        diffColorGreen      = cel2[AnimFrame::COLORGREEN] - startColorGreen
        diffColorBlue       = cel2[AnimFrame::COLORBLUE] - startColorBlue
        diffColorAlpha      = cel2[AnimFrame::COLORALPHA] - startColorAlpha
        diffToneRed         = cel2[AnimFrame::TONERED] - startToneRed
        diffToneGreen       = cel2[AnimFrame::TONEGREEN] - startToneGreen
        diffToneBlue        = cel2[AnimFrame::TONEBLUE] - startToneBlue
        diffToneGray        = cel2[AnimFrame::TONEGRAY] - startToneGray
