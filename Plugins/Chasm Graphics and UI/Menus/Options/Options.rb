...
class Options
    ...
    def mevolume
        @mevolume = 50 if @mevolume.nil?
        return @mevolume / VOLUME_FAKERY_MULT
    end

    attr_writer :mevolume

    def sevolume
        @sevolume = 50 if @sevolume.nil?
    ...
    def initialize
        ...
        @bgmvolume                      = 50 # Volume of background music
        @mevolume                       = 50# Volume of music effects
